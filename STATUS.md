...
- JSON output for extraction results, summaries, and CLI integration payloads
...
- **Unit tests**: Passing (extraction engine, negation handler, normalizer, synthetic data, validation tooling, JSON/rule configuration)
...
- Configurable synonym dictionaries beyond regex pattern overrides
- PyPI publishing
